...
<div class="flex min-h-screen bg-slate-100">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col">
        ...
        <div class="h-16 flex items-center justify-center border-b border-slate-200">
            <span class="text-2xl font-extrabold brand-text-gradient">Gcon</span>
        </div>

        <!-- Nav -->
        <nav class="flex-1 p-4 space-y-2">
            <a href="/Gcon/public/index.php?page=dashboard" 
               class="flex items-center px-3 py-2 rounded-lg hover:bg-violet-50 text-slate-700 font-medium">
               📊 <span class="ml-2">Dashboard</span>
            </a>
            <a href="/Gcon/public/index.php?page=servers"
               class="flex items-center px-3 py-2 rounded-lg hover:bg-violet-50 text-slate-700 font-medium">
               🖥️ <span class="ml-2">Servers</span>
            </a>
            <a href="/Gcon/public/index.php?page=users"
               class="flex items-center px-3 py-2 rounded-lg hover:bg-violet-50 text-slate-700 font-medium">
               👥 <span class="ml-2">Users</span>
            </a>
            <a href="/Gcon/public/index.php?page=settings"
               class="flex items-center px-3 py-2 rounded-lg hover:bg-violet-50 text-slate-700 font-medium">
        ...
        <div class="p-4 border-t border-slate-200">
            ...
            ?>
            <a href="/Gcon/public/index.php?page=profile"
        ...
        <!-- logout -->
        <div class="p-4 border-t border-slate-200">
            <a href="/Gcon/public/index.php?page=logout"
