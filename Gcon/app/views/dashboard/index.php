...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center gap-3 mb-5">
        <form action="/Gcon/public/index.php" method="GET" class="flex-1">
        ...
        <a href="/Gcon/public/index.php?page=servers&action=create"
                ...
                <div class="flex items-start justify-between">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 rounded-xl bg-slate-100 overflow-hidden flex items-center justify-center">
                            <?php if (!empty($s['icon'])): ?>
                                <img src="/Gcon/public/uploads/icon_server/<?= htmlspecialchars($s['icon']) ?>" alt="" class="h-10 w-10 object-cover">
                            <?php else: ?>
